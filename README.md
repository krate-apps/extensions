...
| ---------------------------------------------------------------- | ------------------------------------------------------------- |
| **[`krate-apps/extensions`](https://github.com/krate-apps/extensions)** (this repo) | Optional add-ons published alongside their target apps |
| [`krate-apps/core`](https://github.com/krate-apps/core)          | Official app catalog (mirror)                                 |
| [`krate-apps/sources`](https://github.com/krate-apps/sources)    | Official app handlers (authoring)                             |
| [`runkrate/krate`](https://github.com/runkrate/krate)            | Core `.deb` package (console, setup, HarmonyUI, app catalogs) |
| [`runkrate/web`](https://github.com/runkrate/web)                | HarmonyUI — extension management from the browser             |

## Current extensions

### ruTorrent (`rutorrent/`)

Plugins and themes for the [`rutorrent`](https://github.com/krate-apps/core) app.
...
2. Pick a release from [GitHub Releases](https://github.com/krate-apps/extensions/releases).
...
- [KRATE documentation](https://github.com/runkrate/docs)
