...
theUILang.fErrMsg[11]		= "Opération hors délais.";
...
theUILang.fErrMsg[15]		= "Les binaires de Mediainfo n'ont pas été trouvés, veuillez modifier le fichier config.php.";
...
theUILang.fStops = { 
	...
	CArchive: 	"Création de l'archive arrêtée.",
